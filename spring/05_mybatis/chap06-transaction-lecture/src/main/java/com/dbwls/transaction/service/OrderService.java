package com.dbwls.transaction.service;

import com.dbwls.transaction.domain.Order;
import com.dbwls.transaction.domain.OrderMenu;
import com.dbwls.transaction.dto.OrderDTO;
import com.dbwls.transaction.dto.OrderMenuDTO;
import com.dbwls.transaction.mapper.OrderMapper;
...
public class OrderService {
    ...
    * 주문 정보(tbl_order)와 주문별 메뉴 정보(tbl_order_menu)를 하나의 트랜잭션으로 처리한다. */
    ...
    public void registerOrder(OrderDTO orderDTO, List<OrderMenuDTO> orderMenuDTOs) {
        // DTO(계층을 넘다들기 위해서 사용) -> Domain 변환(실질적으로 DB에서 사용하는 정보 관련 객체) (Order)
