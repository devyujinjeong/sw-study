...
public class MenuServiceIntegrationTest {
    ...
    public void testFindAllMenuByOrderableStatus_Orderable() {
        ...
        // when
        List<MenuDTO> resultList1 = menuService.findAllMenuByOrderableStatus(orderableStatus);
    ...
    public void testFindAllMenuByOrderableStatus_NotOrderable() {
        ...
        // when
        List<MenuDTO> resultList2 = menuService.findAllMenuByOrderableStatus(orderableStatus);
