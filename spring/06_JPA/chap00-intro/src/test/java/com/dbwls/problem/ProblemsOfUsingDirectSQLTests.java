...
public class ProblemsOfUsingDirectSQLTests {
    ...
    * */
    ...
    /* 조회 항목 변경에 따른 의존성 */
    /* 만약 여기에서 MENU_PRICE가 있다면 이 SQL 구문도 수정하고
    * 이에 딸려 있는 자바 코드도 변경해야 한다. */
    @Test
    ...
    *   }
    *
    * 객체 그래프 탐색 문제 -> 예를 들어, 멤버에게 order와 team이 연결되어 있다고 생각하자.
    * 이 때, 조인을 team만 시켜놓으면 .getOrder()은 사용할 수 없다. 즉, 모두 트리 구조로 연결되어 있어야 하는데
    * null 값이 발생하게 되는 것이다.
    * */
    @Test
    ...
    void testEquals() throws SQLException {
        ...
        String query = "SELECT MENU_CODE, MENU_NAME " +
                "FROM TBL_MENU WHERE MENU_CODE = 10";
        ...
        //then
        // 값은 동일한데, 참조값이 달라 다른 객체로 인식하고 있음
