package com.dbwls.nativequery.section01.simple;
...
class NativeQueryRepositoryTest {
    ...
    void testNativeQueryByNoResultType(){
        List<Object[]> menuList = nativeQueryRepository.nativeQueryByManualMapping();
    ...
    @DisplayName("Manual 매핑을 사용한 Native Query 조회 테스트")
    @Test
